        ...
        <div id="home" class="tab-pane fade in active">
            ...
            <table class="form-table" border="0">
                <tr>
                    ...
                    <td colspan="3" ><input class="form-control" class="form-control" name="mhs_nama" type="text" value="<?= $detail_pendaftaran->mhs_nama?>"></td>
                </tr>
                <tr>
                    <td><label>NIK (Nomor KTP)</label></td>
                    <td colspan="3" ><input class="form-control" class="form-control" name="mhs_nik" type="text" value="<?= $detail_pendaftaran->mhs_nik?>"></td>
                </tr>
                <tr>
                    <td><label>Tempat Lahir</label></td>
                    <td><input class="form-control" name="mhs_tempat_lahir" type="text" value="<?= $detail_pendaftaran->mhs_tempat_lahir?>"></td>
                    <td><label for="">Tgl, Bln, Thn Lahir</label></td>
                    <td><input class="form-control" name="mhs_tgl_lahir"type="date" value="<?= $detail_pendaftaran->mhs_tgl_lahir?>"></td>
                </tr>
                <tr>
